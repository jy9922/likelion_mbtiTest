...
function addAnswer(answerText, qIdx, index){
...
function setResult( ){
    ...
    const resultTitle1 = document.querySelector('.resultDescTitle1');
    resultTitle1.innerHTML = infoList[point].descTitle1;
    resultDesc1.innerHTML = infoList[point].desc1;

    const resultDesc2 =document.querySelector('.resultDesc2');
    const resultTitle2 = document.querySelector('.resultDescTitle2');
    resultTitle2.innerHTML = infoList[point].descTitle2;
